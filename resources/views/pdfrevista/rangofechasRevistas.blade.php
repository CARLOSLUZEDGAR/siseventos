    ...
    <main>
        ...
        <div class="cabecera">
                <div style="padding-top: 30px; padding-bottom: 30px; text-align: center; font-size: 15px; font-weight: bold; /*border: 1px solid #C00;*/">
                    <p style="margin: 1px">REPORTE INDIVIDUAL DEL {{$inicio}} AL {{$fin}}</p>
                </div>
                <div style="padding-top: 5px; padding-bottom: 5px; text-align: left; font-size: 12px; font-weight: bold; /*border: 1px solid #C00;*/">
                    
                    <p style="margin: 1px">NOMBRE: @foreach ($personal as $p) {{$p->grado}} {{$p->complemento}} {{$p->per_nombre}} {{$p->per_paterno}} {{$p->per_materno}} @endforeach </p><br>
                    
                    <p  style="margin: 1px">CARNET MILITAR:@foreach ($personal as $p) {{$p->per_cm}}@endforeach</p>
                </div>
                <br>
