    ...
    <main>
        ...
        <div class="cabecera">
                <div style="padding-top: 30px; padding-bottom: 30px; text-align: center; font-size: 15px; font-weight: bold; /*border: 1px solid #C00;*/">
                    <p style="margin: 1px">REPORTES DELEGADO REVISTANTE</p>
                </div>
            ...
            margin-bottom: 5px;" class="table table-bordered table-striped">
                <thead style="background-color: lightgray;">
                    <tr>
                        ...
                        <th style="text-align: center; border: 1px solid #000; height:30px;">NRO. MEMORANDUM</th>
                    </tr>
                </thead>
                <tbody class="table-striped">
                    <?php
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #000; padding: 7px; font-size: 10px;">{{$rp->nro_doc}}</td>
                    </tr>
                    @endif
                    @endforeach
