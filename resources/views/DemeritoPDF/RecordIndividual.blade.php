    ...
    <main>
        <div class="cabecera">
            <div style="padding-top: 5px; padding-bottom: 5px; text-align: center; font-size: 15px; font-weight: bold; /*border: 1px solid #C00;*/">
                <p style="margin: 1px">REPORTE PERSONAL DE FALTAS DISCIPLINARIAS</p>
            </div>            
            <div style="padding-top: 5px; padding-bottom: 5px; margin-left: 2cm; text-align: justify; font-size: 14px; font-weight: normal; /*border: 1px solid #C00;*/">   
                @if($personal->per_sexo=='MASCULINO')
                    <p style="margin: 1px">Revisada la documentación existente en el Departamento I - Personal, se establece que el Señor:</p>
                @endif
            ...
            <div>
                <table width="100%" style="border-collapse: collapse;border-spacing: 0; /*border: black 1px;*/ margin-bottom: 5px; margin-left: 2cm;" class="table table-bordered table-striped">
                    <tbody class="table-striped">
                        <tr>
                            <td width="25%" style="/*border: 1px solid #000;*/ padding: 7px; font-size: 10px; text-align: center;"><span><img style="width:90; height:90; border: 2px solid #142A98;" src="../public/img/personal/{{$personal->per_foto}}"></span></td>
                            <td width="20%" style="/*border: 1px solid #000;*/ padding: 7px; font-size: 10px; text-align: left;">
                                <span>
                                    ...
                                    <p style="margin: 1px; font-size: 14px; font-weight: bold;">AP. PATERNO:</p>
                                    ...
                                    <p style="margin: 1px; font-size: 14px; font-weight: bold;">SIT. MILITAR:</p>
                                </span>
                            </td>
                            <td width="55%" style="/*border: 1px solid #000;*/ padding: 7px; font-size: 10px; text-align: left;">
                                <span>
                                    <p style="margin: 1px; font-size: 14px; /*font-weight: bold;*/"> {{$personal->grado}}{{$personal->estudios}}</p>
                                    <p style="margin: 1px; font-size: 14px; /*font-weight: bold;*/"> {{$personal->per_nombre}}</p>
                                    <p style="margin: 1px; font-size: 14px; /*font-weight: bold;*/"> {{$personal->per_paterno}}</p>
                                    <p style="margin: 1px; font-size: 14px; /*font-weight: bold;*/"> {{$personal->per_materno}}</p>
                                    <p style="margin: 1px; font-size: 14px; /*font-weight: bold;*/"> {{$personal->per_cm}}</p>
                                    <p style="margin: 1px; font-size: 14px; /*font-weight: bold;*/"> {{$personal->subsit}} - {{$personal->detsit}}</p>
                                </span>
                            </td>
                        </tr> 
                    </tbody>
            ...
            <table  id="calobj">
                <thead style="background-color: lightgray;">
                    <tr>
                        ...
                        <th style="text-align: center; border: 1px solid #000; height:20px; width: 13%; font-size: 10px;">SANCIONADOR</th>
                        <th style="text-align: center; border: 1px solid #000; height:20px; width: 5%; font-size: 10px;">DIAS</th>
