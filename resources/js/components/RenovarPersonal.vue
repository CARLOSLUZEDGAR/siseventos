          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <form>
                            <h3><i class="fas fa-inbox"></i>&nbsp;MODIFICAR INFORMACIÓN</h3>
                            <br>
                            ...
                            <div class="form-group row justify-content-end">
                                <button type="button" class="btn btn-danger" @click="RenovarPersonal()"><i class="fas fa-address-card"></i>&nbsp; MODIFICAR</button>
                            </div>
